...
object PermissionUtils {
     ...
     * 权限提示
     */
    fun showPermission(mContext: Activity, titleContent: String,
        ...
        AndPermission.with(mContext).runtime().permission(*permissionStr)
                ...
                .onDenied { permissions ->
                    ...
                    { dialog: DialogInterface, which: Int -> SystemUtil.getAppDetailSettingIntent(mContext) }
     ...
     * 权限提示
     */
    fun showPermission(mContext: Activity, titleName: String,
                       titleContent: String,
                       permissionStr: Array<String>
                       , onGrantedListener: () -> Unit) {
        AndPermission.with(mContext).runtime().permission(*permissionStr)
