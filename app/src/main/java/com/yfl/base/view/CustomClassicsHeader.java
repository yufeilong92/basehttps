...
//        mProgressView.setImageResource(R.drawable.animation_loading_refresh);
        ...
        addView(mProgressView, KotlinUtil.INSTANCE.dp2px(40), KotlinUtil.INSTANCE.dp2px(40));
        addView(mArrowView, KotlinUtil.INSTANCE.dp2px(20), KotlinUtil.INSTANCE.dp2px(20));
        addView(new Space(context), KotlinUtil.INSTANCE.dp2px(20), KotlinUtil.INSTANCE.dp2px(20));
        addView(mHeaderText, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        setMinimumHeight(KotlinUtil.INSTANCE.dp2px(60));
    }
    @NonNull
    public View getView() {
